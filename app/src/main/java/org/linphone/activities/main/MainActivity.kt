...
//                Toast.makeText(this@MainActivity, "Its a toast 2", Toast.LENGTH_SHORT).show()
//            }
        }

//        corePreferences.set

//        Toast.makeText(this@MainActivity, "" + coreContext.core.isPushNotificationAvailable, Toast.LENGTH_SHORT).show()

//        coreContext.core.setR
